...
| `board-states` | Dense six-player board state with occupied spaces, Commander personal locations, spy posts, critical-location control, Maker spice markers, and legal/unavailable placement affordances on desktop/mobile. |
