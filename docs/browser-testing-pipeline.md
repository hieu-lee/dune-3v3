...
| `combat-intrigues` | Combat Intrigue targeting/play flow, Impress pending acquisition, Find Weakness optional spy recall, Spring The Trap required spy recall, Devour optional trash, plus a mobile layout screenshot. |
