...
Use `debug:browser -- --scenario card-choices` for card-generated pending surfaces. Its current artifact contract includes discard/draw panels for Space-time Folding, Guild Envoy, and Guild Spy, Interstellar Trade and Priority Contracts public-contract flows, plus Branching Path and Junction Headquarters Intrigue-trash reward panels, including `pending-guild-spy-discard-draw.png`, `pending-acquire-interstellar-trade-contract.png`, `pending-priority-contracts-contract.png`, `pending-branching-path-trash-intrigue.png`, `pending-junction-headquarters-trash-intrigue.png`, `pending-junction-headquarters-no-pay-trash-intrigue.png`, `pending-strike-fleet-deploy.png`, `pending-pay-resource-troops-no-supply.png`, `pending-paid-reward-no-supply.png`, `intrigue-shaddams-favor-no-supply.png`, and `intrigue-depart-for-arrakis-no-supply.png`.
...
| `board-states` | Dense six-player board state with occupied spaces, Commander personal locations, spy posts, critical-location control, Maker spice markers, legal/unavailable placement affordances, and combat deployment slots on desktop/mobile. |
| `card-choices` | Contract, acquire, Price is No Object Solari acquire, Interstellar Trade acquire Influence/contract bonuses, Priority Contracts Agent public-contract bonus, Dangerous Rhetoric Influence choice, Subversive Advisor and Overthrow board-space Influence, Seek Allies mandatory source trash, Desert Survival, Tread in Darkness, and Shishakli optional source trash, Corrinth City Agent discard and Reveal Solari/High Council branch choice, Delivery Agreement Reveal VP trash, Captured Mentat, Space-time Folding, Guild Envoy, Guild Spy, Branching Path and Junction Headquarters Intrigue trash including Junction's no-pay state, Strike Fleet same-turn spy-recall deployment pending, no-supply paid troop payment surfaces, Shaddam's Favor and Depart For Arrakis no-supply disabled states, Covert Operation, Ecological Testing Station, In High Places and Bene Gesserit Operative spy, and empty acquire pending surfaces. |
...
| `table-choices` | Retreat-for-strength, Chani Fremen Bond, Unswerving Loyalty deploy-or-retreat, Paracompass reveal, Wheels Within Wheels reveal spy, Spy Network reveal spy recall, Calculus trash, Inspire Awe acquisition, Sietch Ritual selected discards, Special Mission City spy placement and spy recall, Change Allegiances Influence shifts/routed losses, Buy Access and Imperium Politics Influence routing, Throne Row, and conflict tie surfaces. |
