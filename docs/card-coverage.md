...
- Reserve cards: Prepare The Way.
- Muad'Dib Commander cards: Demand Attention, Desert Call, Signet Ring, Usul.
...
- Commander starter cards: Command Respect, Demand Results, Threaten Spice Production, Shaddam Signet Ring choices.
...
- Costs: Agent pay resources beyond typed Influence/sandworm payments and Reveal strength/Reveal troop payments, discard card, trash card, lose Influence, recall spy.
