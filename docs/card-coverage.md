...
- Plot and Combat Intrigues: mostly automated through pattern modules and card-specific branches; Contingency Plan, Councilor's Ambition, Leverage, Intelligence Report, Mercenaries, and Shaddam's Favor have been migrated to typed Plot Intrigue specs.
