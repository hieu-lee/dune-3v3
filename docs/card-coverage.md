...
- Costs: Agent pay resources beyond typed draw-card/Influence/sandworm/contract/team-VP payments and Reveal strength/troop/sandworm payments, discard card outside typed discard-for-draw/Influence-draw effects, non-trade Agent trash card, lose Influence outside typed Plot branches, recall spy.
