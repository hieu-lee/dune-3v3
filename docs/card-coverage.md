...
- Plot and Combat Intrigues: mostly automated through pattern modules and card-specific branches; Contingency Plan, Councilor's Ambition, Depart For Arrakis, Leverage, Intelligence Report, Mercenaries, Market Opportunity, Shaddam's Favor, and Strategic Stockpiling have been migrated to typed Plot Intrigue specs.
...
- Costs: Agent pay resources beyond typed draw-card/Influence/sandworm/contract/team-VP payments and Reveal strength/troop/sandworm payments, discard card outside typed discard-for-draw/Influence-draw effects, non-trade trash card, lose Influence, recall spy.
