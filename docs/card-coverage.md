...
- Plot and Combat Intrigues: mostly automated through pattern modules and card-specific branches; Backed by CHOAM, Contingency Plan, Councilor's Ambition, Depart For Arrakis, Leverage, Intelligence Report, Mercenaries, Market Opportunity, Shaddam's Favor, and Strategic Stockpiling have been migrated to typed Plot Intrigue specs.
