...
- Plot Intrigue cards: Contingency Plan uses typed `plot-intrigue` specs for its immediate Solari gain; Leverage uses typed `plot-intrigue` specs for its turn-spice-gated Solari gain and optional public CHOAM contract pending action.
...
- Plot and Combat Intrigues: mostly automated through pattern modules and card-specific branches; Contingency Plan and Leverage have been migrated to typed Plot Intrigue specs.
