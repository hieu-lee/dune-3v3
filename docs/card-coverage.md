...
- Plot and Combat Intrigues: mostly automated through pattern modules and card-specific branches; Backed by CHOAM, Call to Arms, Contingency Plan, Councilor's Ambition, Cunning, Depart For Arrakis, Distraction, Leverage, Intelligence Report, Manipulate, Mercenaries, Opportunism, Market Opportunity, Shaddam's Favor, and Strategic Stockpiling have been migrated to typed Plot Intrigue specs.
