...
- Commander starter cards: Demand Results, Threaten Spice Production, Shaddam Signet Ring choices.
...
- Costs: Agent pay resources beyond typed Influence/sandworm payments and Reveal strength/Reveal troop payments, discard card, non-trade trash card, lose Influence, recall spy.
