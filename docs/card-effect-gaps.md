...
- Effects: gain persuasion, gain strength, gain resource, draw cards, draw Intrigues, recruit troops, place spies, optional Agent card discard for Influence and card draw, optional Reveal troop retreat for strength, optional Reveal card trash for strength, optional Reveal Influence loss for Intrigue draw
