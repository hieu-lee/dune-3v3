...
- Plot Intrigue modules
  - Economy, influence, spy, tactical, and acquisition effects are mostly automated but not declarative; Leverage is the first typed Plot Intrigue spec migration.
