...
- Current Plot Intrigue implementation lets the active player score the Plot side of Crysknife, Desert Mouse, and Ornithopter for 1 VP during Agent or Reveal turns.
