...
- Current Commander starter-card implementation automates Imperial Tent, Command Respect's Swordmaster-gated trash-to-trade effect, Demand Attention's typed optional faction Influence payment, Desert Call's typed optional water-for-sandworm trash payment, Threaten Spice Production's shared 7-spice VP/trash payment, Usul's Muad'Dib/activated-Ally water-or-spice split, Critical Shipments' Shaddam/activated-Ally water-or-2-Solari split, Corrino Might's typed optional 3-spice Reveal troop payment, Devastating Assault's typed Agent reward and declarative Swordmaster-gated Reveal payment, and Demand Results' optional Shaddam contract assignment.
...
- Current Imperium-card implementation exposes both Reserve stacks, tracks Maker board-space Agent visits through the round so Smuggler's Harvester can pay its conditional Reveal spice, resolves Interstellar Trade's Reveal persuasion from completed contracts when the Reveal plan is created, prompts Calculus of Power's optional Reveal trash for another Emperor card in play before adding its 3 strength, and resolves Prepare The Way's 2+ Bene Gesserit Influence Agent draw with 3v3 shared Influence.
