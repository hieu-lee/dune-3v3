...
- Current Imperium-card implementation tracks Maker board-space Agent visits through the round so Smuggler's Harvester can pay its conditional Reveal spice.
