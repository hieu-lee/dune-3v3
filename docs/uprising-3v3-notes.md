...
- Current Commander starter-card implementation automates Imperial Tent, Usul's Muad'Dib/activated-Ally water-or-spice split, Critical Shipments' Shaddam/activated-Ally water-or-2-Solari split, Devastating Assault's Agent reward, and Demand Results' optional Shaddam contract assignment.
