...
- The Spice Must Flow uses typed acquire effects for its fixed 1 VP and 1 spice rewards. The acquire resolver treats explicit acquire specs as authoritative, so its legacy `acquired` display field does not double-count VP.
