...
import { verifyStarterDeckCommanderResourceSplits } from "./verify-starter-decks-commander-resource-splits.mjs";
...
try {
  ...
  verifyStarterDeckCommanderResourceSplits({
    data,
    game,
    players: { emperor, muadDib, muadDibAllyA, muadDibAllyB, shaddamAlly, shaddamAllyB },
    state,
  });
  ...
  assert.ok(acceptContract, "Accept Contract should exist for Devastating Assault non-combat-space regression");
