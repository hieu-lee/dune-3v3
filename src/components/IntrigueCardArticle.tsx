...
import { factionShortLabels, selectedFactionChoice } from "../app-helpers";
import {
...
type IntrigueCard = Player["intrigues"][number];

type IntrigueCardArticleProps = IntrigueHandPanelProps & {
  card: IntrigueCard;
};

export function IntrigueCardArticle({
  activePlayer,
  activatedAlly,
  card,
  ...
  return (
    <article className="intrigue-card">
