...
export const weirdingWomanSourceId = 14;
...
export const desertSurvivalSourceId = 27;
export const desertPowerSourceId = 71;
...
export const corrinthCitySourceId = 69;
export const cargoRunnerSourceId = 181;
export const deliveryAgreementSourceId = 182;
